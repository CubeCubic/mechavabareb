...
class UniversityRecommendationSystem:
    ...
    def _get_city(self, uni_code: int) -> str:
        city_map = {
            ...
            120: 'თბილისი', 121: 'თბილისი', 122: 'თბილისი', 129: 'თბილისი',
            130: 'ბათუმი', 131: 'თბილისი', 133: 'გორი', 140: 'ბათუმი',
            142: 'სოფ. ხიჭაური', 143: 'თბილისი', 145: 'თბილისი', 152: 'თბილისი',
            153: 'თბილისი', 154: 'თბილისი', 155: 'გორი', 171: 'თბილისი',
            172: 'თბილისი', 177: 'თბილისი', 181: 'თბილისი', 183: 'თბილისი',
            186: 'თბილისი', 192: 'ბათუმი', 195: 'თბილისი', 197: 'ქუთაისი',
            198: 'თბილისი', 199: 'თბილისი', 201: 'თბილისი', 202: 'თბილისი',
            203: 'თბილისი', 204: 'თბილისი', 205: 'ბათუმი', 206: 'თბილისი',
            173: 'ახალციხე', 174: 'ქუთაისი', 175: 'თბილისი', 184: 'ბათუმი',
            194: 'ახალციხე'
        }
    ...
    def calculate_score(self, program: pd.Series, exam_scores: Dict[str, float]) -> Dict:
        ...
        for i in range(1, 5):
            ...
            scaled_score = raw_score * 2.0  # Max 100 to 200
        ...
        if total_candidates:
            best_elective = max(total_candidates, key=lambda x: x['contribution'])
