...
def get_required_exams():
    ...
    return jsonify({
        ...
        'elective_exams': elective_clean[:15]
    })
...
def get_recommendations():
    ...
    if foreign_language:
        ...
        exam_scores['უცხოური ენა (გერმ.; ინგ.; რუს.; ფრან.)'] = foreign_score
        exam_scores['უცხოური ენა (ინგ.; რუს.; გერმ.; ფრან.)'] = foreign_score
        exam_scores['უცხოური ენა (გერმ.)'] = foreign_score
